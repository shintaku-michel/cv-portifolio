...
import perfilBg from '@/assets/img/perfil.png'
  ...
  <div class="flex flex-col gap-24">
    <Transition name="section-fade" mode="out-in">
      <section v-if="activeSection === 'inicio'" id="inicio" key="inicio" class="h-dvh">
        <RevealMask class="flex flex-col items-center justify-center gap-4 text-center" :background-src="perfilBg">
          <div class="relative">
          ...
          <p class="max-w-3xl text-muted-foreground">
            Crio produtos digitais que unem tecnologia e estratégia, com foco no usuário, transformando necessidades
            reais
      ...
      <section v-else-if="activeSection === 'perfil'" id="perfil" key="perfil" class="h-dvh">
        <RevealMask class="flex flex-col items-center justify-start gap-4 pt-32" :background-src="perfilBg">
          <div class="w-full max-w-3xl">
            ...
            <p class="text-muted-foreground mb-4">
              ...
              O design, a música, a tecnologia e a cultura japonesa são influências que fizeram parte da minha formação
              e
      ...
      <section v-else-if="activeSection === 'valores'" id="valores" key="valores" class="h-dvh">
        <RevealMask class="flex flex-col items-center justify-start gap-4 pt-32" :background-src="perfilBg">
          <div class="w-full max-w-3xl">
      ...
      <section v-else-if="activeSection === 'formacao'" id="formacao" key="formacao" class="h-dvh">
        <RevealMask class="flex flex-col items-center justify-center gap-4 text-left" :background-src="perfilBg">
          <h1 class="mb-4 text-2xl font-semibold">
            Formação
          </h1>
          <p class="text-muted-foreground max-w-3xl">
      ...
      <section v-else-if="activeSection === 'cursos'" id="cursos" key="cursos" class="h-dvh">
        <RevealMask class="flex flex-col items-center justify-center gap-4 text-left" :background-src="perfilBg">
          <h1 class="mb-4 text-2xl font-semibold">
            Cursos
          </h1>
      ...
      <section v-else-if="activeSection === 'experiencia'" id="experiencia" key="experiencia" class="h-dvh">
        <RevealMask class="flex flex-col items-center justify-center gap-4 text-left" :background-src="perfilBg">
          <h1 class="mb-4 text-2xl font-semibold">
            Experiência
          </h1>
          <p class="text-muted-foreground max-w-3xl">
            Sempre fui muito curioso e gosto de entender como as coisas funcionam. Ao longo da minha carreira, fiz
            cursos
          ...
          <p class="text-muted-foreground max-w-3xl">
            ...
            para colocar uma aplicação para funcionar, usando tecnologias como Spring, Hibernate, Tomcat ou JBoss, além
            do
            Angular no frontend. Mas minha curiosidade acabou me levando também para o Frontend, uma área em que comecei
            a
          ...
          <p class="text-muted-foreground max-w-3xl">
            ...
            fundamental para criar produtos melhores — e que renderia muitas horas de conversa. Mais tarde, ao voltar
            para
      ...
      <section v-else-if="activeSection === 'projetos'" id="projetos" key="projetos" class="h-dvh scroll-mt-8">
        <RevealMask :background-src="perfilBg">
      ...
      <section v-else-if="activeSection === 'blog'" id="blog" key="blog" class="h-dvh scroll-mt-8">
        <RevealMask :background-src="perfilBg">
          <div class="ml-16 h-full">
            <div class="mx-auto max-w-7xl px-6 py-8">
              <div class="mb-6 flex items-center justify-between">
      ...
      <section v-else-if="activeSection === 'contato'" id="contato" key="contato" class="h-dvh scroll-mt-8">
        <RevealMask :background-src="perfilBg">
          <div class="ml-16 h-full">
            <div class="mx-auto max-w-7xl px-6 py-8">
              <h1 class="mb-4 text-2xl font-semibold">
