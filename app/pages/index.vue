...
<template>
  <div class="flex flex-col gap-24">
    <Transition name="section-fade" mode="out-in">
      ...
      <section v-else-if="activeSection === 'perfil'" id="perfil" key="perfil" class="scroll-mt-8">
      ...
      <section v-else-if="activeSection === 'valores'" id="valores" key="valores" class="scroll-mt-8">
        <h1 class="mb-4 text-2xl font-semibold">
          Valores
        </h1>
        <p class="text-muted-foreground">
      ...
      <section v-else-if="activeSection === 'formacao'" id="formacao" key="formacao" class="scroll-mt-8">
        <h1 class="mb-4 text-2xl font-semibold">
          Formação
        </h1>
        <p class="text-muted-foreground">
      ...
      <section v-else-if="activeSection === 'cursos'" id="cursos" key="cursos" class="scroll-mt-8">
        <h1 class="mb-4 text-2xl font-semibold">
          Cursos
        </h1>
        <p class="text-muted-foreground">
      ...
      <section v-else-if="activeSection === 'experiencia'" id="experiencia" key="experiencia" class="scroll-mt-8">
        <h1 class="mb-4 text-2xl font-semibold">
          Experiência
        </h1>
        <p class="text-muted-foreground">
