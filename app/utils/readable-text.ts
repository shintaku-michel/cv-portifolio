...
// só o texto, sem formatação. Recebe o HTML já pronto (posts/projetos são
// escritos no Tiptap, que serializa direto pra HTML). Só roda no cliente
// (usa o DOM do navegador pra não reescrever um parser de HTML só pra isso).
